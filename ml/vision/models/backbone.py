...
def resnet50(pretrained=False, fpn=False, frozen=True, exceptions=['layer2', 'layer3', 'layer4'], progress=True, **kwargs):
...
def resnet101(pretrained=False, fpn=False, frozen=True, exceptions=['layer2', 'layer3', 'layer4'], progress=True, **kwargs):
...
def resnext101(pretrained=False, fpn=False, frozen=True, exceptions=['layer2', 'layer3', 'layer4'], progress=True, **kwargs):
